...
export default function MovieCard({ movie }) {
  return (
    <div className="border-none rounded p-4 shadow-2xl hover:scale-105 transition-normal duration-300">
      ...
      <Link to={`/show/${movie.id}`}>
        <button className="bg-blue-600 text-white mt-3 px-4 py-2 rounded w-full cursor-pointer">Book Now</button>
      </Link>
    </div>
  );
}